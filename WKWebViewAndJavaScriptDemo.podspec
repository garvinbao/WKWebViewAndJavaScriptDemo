#
#  Be sure to run `pod spec lint WKWebViewAndJavaScriptDemo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files = "WKWebViewAndJavaScriptDemo/*"
  # s.source_files  = "WKWebViewAndJavaScriptDemo/.{h,m}"
